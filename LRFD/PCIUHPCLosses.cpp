...
Float64 lrfdPCIUHPCLosses::GetShrinkageStrain_Deck() const
{
    if (m_bUHPCSlab)
        return (m_bPCTTSlab ? 0.0 : 0.30e-03);
    else
        return __super::GetShrinkageStrain_Deck();
}
