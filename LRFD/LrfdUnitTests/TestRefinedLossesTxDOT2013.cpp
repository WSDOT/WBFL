...
{
	TEST_CLASS(TestRefinedLossesTxDOT2013)
	{
	public:
		...
		TEST_METHOD(Test)
		{
         ...
         RefinedLossesTxDOT2013 loss(19.5072, // location along girder where losses are computed
         ...
         Assert::AreEqual(56199167.768542737, loss.ShrinkageLosses(), 0.00001);
         Assert::AreEqual(94276196.292824641, loss.CreepLosses(), 0.00001);
         Assert::AreEqual(9392020.8963202052, loss.RelaxationLossBeforeDeckPlacement(), 0.00001);
         Assert::AreEqual(9392020.8963202052, loss.RelaxationLossAfterDeckPlacement(), 0.00001);
         Assert::AreEqual(169259405.85400778, loss.TimeDependentLossesBeforeDeck(), 0.00001);
         Assert::AreEqual(0, loss.TimeDependentLossesAfterDeck(), 0.00001);
         Assert::AreEqual(169259405.85400778, loss.TimeDependentLosses(), 0.00001);

         // permanent strands
         Assert::AreEqual(0.0, loss.PermanentStrand_ImmediatelyBeforeXferLosses(), 0.00001);
         Assert::AreEqual(0.0, loss.PermanentStrand_BeforeTransfer(), 0.00001);
         Assert::AreEqual(0.0, loss.PermanentStrand_AfterTransfer(), 0.00001);
         Assert::AreEqual(108188112.50561596, loss.PermanentStrand_ImmediatelyAfterXferLosses(), 0.00001);
         Assert::AreEqual(0.0, loss.PermanentStrand_AfterTemporaryStrandInstallation(), 0.00001);
         Assert::AreEqual(0.0, loss.PermanentStrand_AtLifting(), 0.00001);
         Assert::AreEqual(84629702.927003890, loss.PermanentStrand_AtShipping(), 0.00001);
         Assert::AreEqual(84629702.927003890, loss.PermanentStrand_TimeDependentLossesAtShipping(), 0.00001);
         Assert::AreEqual(84629702.927003890, loss.PermanentStrand_BeforeTemporaryStrandRemoval(), 0.00001);
         Assert::AreEqual(84629702.927003890, loss.PermanentStrand_AfterTemporaryStrandRemoval(), 0.00001);
         Assert::AreEqual(169259405.85400778, loss.PermanentStrand_AfterDeckPlacement(), 0.00001);
         Assert::AreEqual(169259405.85400778, loss.PermanentStrand_AfterSIDL(), 0.00001);
         Assert::AreEqual(169259405.85400778, loss.PermanentStrand_Final(), 0.00001);

         // temporary strands
         Assert::AreEqual(0.0, loss.TemporaryStrand_ImmediatelyBeforeXferLosses(), 0.00001);
         Assert::AreEqual(0.0, loss.TemporaryStrand_BeforeTransfer(), 0.00001);
         Assert::AreEqual(0.0, loss.TemporaryStrand_AfterTransfer(), 0.00001);
         Assert::AreEqual(43942003.372044489, loss.TemporaryStrand_ImmediatelyAfterXferLosses(), 0.00001);
         Assert::AreEqual(0.0, loss.TemporaryStrand_AfterTemporaryStrandInstallation(), 0.00001);
         Assert::AreEqual(0.0, loss.TemporaryStrand_AtLifting(), 0.00001);
         Assert::AreEqual(84629702.927003890, loss.TemporaryStrand_AtShipping(), 0.00001);
         Assert::AreEqual(84629702.927003890, loss.TemporaryStrand_TimeDependentLossesAtShipping(), 0.00001);
         Assert::AreEqual(84629702.927003890, loss.TemporaryStrand_BeforeTemporaryStrandRemoval(), 0.00001);
