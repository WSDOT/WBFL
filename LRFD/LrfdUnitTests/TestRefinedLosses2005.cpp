...
{
	TEST_CLASS(TestRefinedLosses2005)
	{
	public:
		...
		TEST_METHOD(Test)
		{
         ...
         RefinedLosses2005 loss(19.5072, // location along girder where losses are computed
         ...
         Assert::AreEqual(55943871.442225523, loss.PermanentStrand_AtShipping(), 0.00001);
         Assert::AreEqual(55943871.442225523, loss.PermanentStrand_BeforeTemporaryStrandRemoval(), 0.00001);
         Assert::AreEqual(55943871.442225523, loss.PermanentStrand_AfterTemporaryStrandRemoval(), 0.00001);
         Assert::AreEqual(163455953.25443751, loss.PermanentStrand_AfterDeckPlacement(), 0.00001);
         Assert::AreEqual(163455953.25443751, loss.PermanentStrand_AfterSIDL(), 0.00001);
         Assert::AreEqual(178391688.87407646, loss.PermanentStrand_Final(), 0.00001);
         ...
         Assert::AreEqual(52381165.854266986, loss.TemporaryStrand_AtShipping(), 0.00001);
         Assert::AreEqual(52381165.854266986, loss.TemporaryStrand_BeforeTemporaryStrandRemoval(), 0.00001);
