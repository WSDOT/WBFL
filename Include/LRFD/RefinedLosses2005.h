...
namespace WBFL
{
   namespace LRFD
   {
      /// @brief Utility class for computing prestress losses using the LRFD Refined Estimate Method.
      class LRFDCLASS RefinedLosses2005 : public Losses
      {
      public:
         enum class RelaxationLossMethod { 
         ...
         RefinedLosses2005(Float64 x, // location along girder where losses are computed
                               ...
                               std::shared_ptr<const CreepCoefficient2005>& pGirderCreepLoaded,
                               std::shared_ptr<const CreepCoefficient2005>& pDeckCreep
                               );
         
         RefinedLosses2005(const RefinedLosses2005&) = default;
         ~RefinedLosses2005() = default;

         RefinedLosses2005& operator=(const RefinedLosses2005&) = default;
         ...
         //------------------------------------------------------------------------
         std::shared_ptr<const CreepCoefficient2005> GetGirderCreep() const;
         std::shared_ptr<const CreepCoefficient2005> GetDeckCreep() const;
         ...
         // 0.5 for half deck shrinkage, and so on.
      ...
      protected:
         ...
         std::shared_ptr<const CreepCoefficient2005> m_pGirderCreep;
         std::shared_ptr<const CreepCoefficient2005> m_pDeckCreep;
      ...
      inline void RefinedLosses2005::SetDeckEccentricity(Float64 e) { m_ed; m_IsDirty = true; }
      inline Float64 RefinedLosses2005::GetDeckEccentricity() const { return m_ed; }
      inline void RefinedLosses2005::SetAd(Float64 Ad) { m_Ad = Ad; m_IsDirty = true; }
      inline Float64 RefinedLosses2005::GetAd() const { return m_Ad; }
      inline void RefinedLosses2005::SetDeckShrinkageFactor(Float64 Ksh) { m_Ksh = Ksh; m_IsDirty = true; }
      inline Float64 RefinedLosses2005::GetDeckShrinakgeFactor() const { return m_Ksh; }
   };
};
