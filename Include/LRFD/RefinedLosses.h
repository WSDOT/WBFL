...
namespace WBFL
{
   namespace LRFD
   {
      ...
      class LRFDCLASS RefinedLosses : public Losses
      {
      public:
         RefinedLosses() = default;
         RefinedLosses(Float64 x, // location along girder where losses are computed
         ...
         RefinedLosses(const RefinedLosses&) = default;
         ~RefinedLosses() = default;

         RefinedLosses& operator=(const RefinedLosses&) = default;
