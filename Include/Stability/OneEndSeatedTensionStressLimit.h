...
namespace WBFL
{
   namespace Stability
   {
      ...
      public:
         ...
         virtual void ReportTensionLimit(rptParagraph* pPara, const WBFL::Units::IndirectMeasure* pDisplayUnits) const = 0;

         /// Reports the required concrete strength to satisfy the tension stress limit
         virtual void ReportRequiredConcreteStrength(const OneEndSeatedCheckArtifact* pArtifact, rptParagraph* pPara, const WBFL::Units::IndirectMeasure* pDisplayUnits) const = 0;
      };
      ...
      public:
         ...
         virtual void ReportRequiredConcreteStrength(const OneEndSeatedCheckArtifact* pArtifact, rptParagraph* pPara, const WBFL::Units::IndirectMeasure* pDisplayUnits) const override;
