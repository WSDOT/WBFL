...
struct EAFCLASS CEAFReportViewCreationData
{
   ...
   std::shared_ptr<WBFL::ReportMgr::ReportSpecification> m_pRptSpecification; // the report specification
   std::shared_ptr<const WBFL::ReportMgr::ReportSpecificationBuilder> m_pRptSpecificationBuilder; // and the corresponding builder
   ...
   // The report manager
   std::shared_ptr<const WBFL::ReportMgr::ReportBuilderManager> m_pReportBuilderMgr; // Use this when using regular Doc/View
...
public:
   ...
   std::shared_ptr<const WBFL::ReportMgr::ReportBuilderManager> m_pReportBuilderMgr;
...
// Implementation
public:
   virtual void UpdateNow(const std::shared_ptr<const WBFL::ReportMgr::ReportHint>& pHint);
...
public:
   ...
   virtual bool InitReport(std::shared_ptr<WBFL::ReportMgr::ReportSpecification>& pSpec, const std::shared_ptr<const WBFL::ReportMgr::ReportSpecificationBuilder>& pSpecBuilder);
   ...
   virtual bool CreateReport(IndexType rptIdx, std::shared_ptr<WBFL::ReportMgr::ReportSpecification>& pSpec, const std::shared_ptr<const WBFL::ReportMgr::ReportSpecificationBuilder>& pSpecBuilder);

   // listen if our button was clicked
   void NotifyReportButtonWasClicked();

   std::shared_ptr<const WBFL::ReportMgr::ReportSpecification> GetReportSpecification() const;
...
protected:
   ...
   virtual HRESULT UpdateReportBrowser(const std::shared_ptr<const WBFL::ReportMgr::ReportHint>&  pHint);
   ...
   virtual WBFL::ReportMgr::ReportHint* TranslateHint(CView* pSender, LPARAM lHint, CObject* pHint);


protected:
   std::shared_ptr<WBFL::ReportMgr::ReportBrowser> m_pReportBrowser;
   std::shared_ptr<WBFL::ReportMgr::ReportSpecification> m_pReportSpec;
   std::shared_ptr<const WBFL::ReportMgr::ReportSpecificationBuilder> m_pRptSpecBuilder;
...
private:
   ...
   std::shared_ptr<const WBFL::ReportMgr::ReportBuilder> GetReportBuilder(const std::_tstring& strRptName) const;
   std::shared_ptr<WBFL::ReportMgr::ReportBrowser> CreateReportBrowser(HWND hwndParent, DWORD dwStyle,const std::shared_ptr<WBFL::ReportMgr::ReportSpecification>& pRptSpec, const std::shared_ptr<const WBFL::ReportMgr::ReportSpecificationBuilder>& pRptSpecBuilder);
};
