...
namespace WBFL {
   namespace EAF {
      ...
      // This class provides a ready-to-use implementation for IPluginApp methods
      // associated with application documentation.
      //
      // Create an instance of this class in your IPluginApp implementation
      // and call the Init function with the documentation set name. Delegate
      // the calls to the application documentation related methods in IPluginApp
      // to the methods implemented in this class
      class EAFCLASS PluginAppDocumentationImpl
      {
      public:
         PluginAppDocumentationImpl();
         ~PluginAppDocumentationImpl();

         // Initialize with a documentation set name
         void Init(std::weak_ptr<WBFL::EAF::IPluginApp> pPluginApp);
         ...
         std::pair<WBFL::EAF::HelpResult,CString> GetDocumentLocation(LPCTSTR lpszDocSetName,UINT nID);

      private:
         std::weak_ptr<WBFL::EAF::IPluginApp> m_pPluginApp; // weak reference
