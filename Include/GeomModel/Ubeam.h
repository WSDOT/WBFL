...
namespace WBFL
{
   namespace Geometry
   {
      ...
      class GEOMMODELCLASS UBeam :  public FlangedBeam
      {
      public:
         UBeam();

         UBeam(Float64 w1, Float64 w2, Float64 w3, Float64 w4, Float64 w5,
         ...
         UBeam(const UBeam& other) = default;

         virtual ~UBeam();

         UBeam& operator=(const UBeam& other) = default;
