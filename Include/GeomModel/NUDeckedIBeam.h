...
namespace WBFL
{
   namespace Geometry
   {
      ...
      class GEOMMODELCLASS NUDeckedIBeam : public FlangedBeam
      {
      public:

         NUDeckedIBeam();

         NUDeckedIBeam(Float64 w1, Float64 w2, Float64 w3, Float64 w4,Float64 h, Float64 d1, Float64 d2, Float64 d3,Float64 d4,Float64 d5,Float64 d6,Float64 t,Float64 r1,Float64 r2, Float64 c1, std::shared_ptr<Point2d>& hookPnt);

         NUDeckedIBeam(const NUDeckedIBeam& other) = default;
         NUDeckedIBeam& operator=(const NUDeckedIBeam& other) = default;

         virtual ~NUDeckedIBeam() override;
