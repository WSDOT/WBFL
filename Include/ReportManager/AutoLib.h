...
#define REPORTMANAGER_AUTOLIBNAME "WBFLReportManager.lib"

#pragma comment(lib,REPORTMANAGER_AUTOLIBNAME)
#if defined AUTOLIB
#pragma message("Linking with " REPORTMANAGER_AUTOLIBNAME )
#endif
