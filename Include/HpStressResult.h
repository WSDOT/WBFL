...
{
	STDMETHOD(HpSumResults)(/*[in]*/IndexType num, /*[in]*/double* Vals)=0;
	STDMETHOD(HpSetResults)(/*[in]*/IndexType num, /*[in]*/double* Vals)=0;
};
...
{
	STDMETHOD(HpSumResults)(/*[in]*/IndexType numLeft, /*[in]*/double* leftVals, /*[in]*/IndexType numRight, /*[in]*/double* rightVals)=0;
