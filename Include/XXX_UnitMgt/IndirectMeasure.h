...
namespace WBFL
{
   namespace Units
   {
      ...
      {
      public:
         IndirectMeasureDataT(const T& um,Float64 t = 0.001,Int16 w = 6,Int16 p = 3) :
      ...
      #define DECLARE_INDIRECT_MEASURE_DATA(u,t) \
         UNITMGTTPL IndirectMeasureDataT<u>; \
      ...
      /// as a value for LibraryT.
      class UNITMGTCLASS IndirectMeasure
      {
      public:
