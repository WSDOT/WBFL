...
namespace WBFL
{
   namespace Units
   {
      ...
      class UNITMGTCLASS PhysicalConverter: public sysNumericFormatTool
      {
      public:
      ...
      UNITMGTTPL ScalarFormatToolT<ScalarData>;
      UNITMGTTPL UnitValueNumericalFormatToolT<LengthData>;
      UNITMGTTPL UnitValueNumericalFormatToolT<MomentData>;
      UNITMGTTPL UnitValueNumericalFormatToolT<LengthData>;
      UNITMGTTPL UnitValueNumericalFormatToolT<AngleData>;
      UNITMGTTPL UnitValueNumericalFormatToolT<StressData>;
      UNITMGTTPL UnitValueNumericalFormatToolT<ForceData>;
      UNITMGTTPL UnitValueNumericalFormatToolT<ForceData>;
      UNITMGTTPL UnitValueNumericalFormatToolT<TimeData>;
      UNITMGTTPL UnitValueNumericalFormatToolT<Length2Data>;
      UNITMGTTPL UnitValueNumericalFormatToolT<Length3Data>;
      UNITMGTTPL UnitValueNumericalFormatToolT<Length4Data>;
      UNITMGTTPL UnitValueNumericalFormatToolT<PerLengthData>;
