...
#ifndef INCLUDED_FOREIGNDRAGDROPTASK_H_
#define INCLUDED_FOREIGNDRAGDROPTASK_H_
#pragma once

interface iForeignDragDropTask : public IUnknown
{
...
#endif // INCLUDED_FOREIGHDRAGDROPTASK_H_