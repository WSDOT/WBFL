...
#ifndef INCLUDED_MATH_BISESCTIONROOTFINDER2D_H_
#define INCLUDED_MATH_BISESCTIONROOTFINDER2D_H_
#pragma once
...
LOG
   rab : 01.29.1999 : Created file
*****************************************************************************/

class MATHCLASS mathBisectionRootFinder2d : public mathRootFinder2d
{
public:
   // GROUP: LIFECYCLE
   ...
   //------------------------------------------------------------------------
   // Destructor
   virtual ~mathBisectionRootFinder2d();
...
#endif // INCLUDED_MATH_BISESCTIONROOTFINDER2D_H_
