...
public:
   ...
   // Wraps an already-existing core Member (discovered while rehydrating
   // COM wrappers after CModel::Load()).
   void AdoptCore(WBFL::FEA2D::Member* pCore);
...
public:
	...
	STDMETHOD(Remove)(/*[in]*/IndexType IDorIndex, /*[in]*/Fem2dAccessType AccessMethod,/*[out,retval]*/MemberIDType* pid) override;
