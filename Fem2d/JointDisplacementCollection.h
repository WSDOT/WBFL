...
public:
   ...
   // Wraps an already-existing core JointDisplacement (discovered while
   // rehydrating COM wrappers after CModel::Load()).
   void AdoptCore(WBFL::FEA2D::JointDisplacement* pCore);
