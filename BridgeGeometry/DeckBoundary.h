...
public:
   ...
   STDMETHOD(get_PerimeterEx)(CollectionIndexType nMinPointsPerSide,PierIDType startPierID,Float64 Xstart,PierIDType endPierID,Float64 Xend,IPoint2dCollection** points) override;
