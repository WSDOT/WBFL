...
#pragma Reminder("Improve these tests")
   ...
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,25.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,25.0,sbLeft,1,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
...
void CTestSectionCutTool::TestSplicedGirderBridge()
{
   ...
   IndexType beamIdx, slabIdx;
   CComPtr<ISection> section;
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,0.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,50.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,100.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,125.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,175.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,200.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,225.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   //
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,250.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   //
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,275.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   // cut section at end
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,300.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   // 
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,325.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   // 
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,375.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   // 
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,400.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   // 
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,450.0,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
   ...
   // 
   section.Release();
   TRY_TEST(tool->CreateGirderSectionBySSMbr(bridge,ssMbrID,500,sbLeft,3,spmGross,hdmHaunchIsZero,&beamIdx,&slabIdx,&section),S_OK);
