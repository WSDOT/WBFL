...
/////////////////////////////////////////////////////////////////////////////
// CWebBrowser: Web browser control
/////////////////////////////////////////////////////////////////////////////
...
public:
	...
	BOOL Create(LPCTSTR pszWindowName, DWORD dwStyle, 
	            const RECT& rect, 
               CWnd* pParentWnd, 
               UINT nID);
	...
	enum NotificationType {					// Note: CWebBrowser does NOT support the
	...
	public:
		...
		NMHDR			hdr;				// hdr.hwndFrom = CWebBrowser's HWND
											// hdr.idFrom   = CWebBrowser's control ID
