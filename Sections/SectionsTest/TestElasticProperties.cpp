...
// TestElasticProperties.cpp: implementation of the CTestElasticProperties class.
//
//////////////////////////////////////////////////////////////////////
...
CTestElasticProperties::CTestElasticProperties()
{
...
void CTestElasticProperties::Test()
{
   CComPtr<IElasticProperties> props;
   TRY_TEST( props.CoCreateInstance( CLSID_ElasticProperties ), S_OK );
   ...
   // Test properties
   //
   TRY_TEST( props->put_EA(area), S_OK );
   TRY_TEST( props->get_EA(nullptr), E_POINTER );
   TRY_TEST( props->get_EA(&val), S_OK );
   TRY_TEST( IsEqual(val,area), true );

   TRY_TEST( props->put_EIxx(ixx), S_OK );
   TRY_TEST( props->get_EIxx(nullptr), E_POINTER );
   TRY_TEST( props->get_EIxx(&val), S_OK );
   TRY_TEST( IsEqual(val,ixx), true );

   TRY_TEST( props->put_EIyy(iyy), S_OK );
   TRY_TEST( props->get_EIyy(nullptr), E_POINTER );
   TRY_TEST( props->get_EIyy(&val), S_OK );
   TRY_TEST( IsEqual(val,iyy), true );

   TRY_TEST( props->put_EIxy(ixy), S_OK );
   TRY_TEST( props->get_EIxy(nullptr), E_POINTER );
   TRY_TEST( props->get_EIxy(&val), S_OK );
   ...
   // Principle Values
   //
   TRY_TEST( props->get_EI11(nullptr), E_POINTER );
   TRY_TEST( props->get_EI11(&val), S_OK );
   TRY_TEST( IsEqual(val,30.20176), true );

   TRY_TEST( props->get_EI22(nullptr), E_POINTER );
   TRY_TEST( props->get_EI22(&val), S_OK );
   TRY_TEST( IsEqual(val,7.248239), true );

   TRY_TEST( props->get_EI12Min(nullptr), E_POINTER );
   TRY_TEST( props->get_EI12Min(&val), S_OK );
   TRY_TEST( IsEqual(val,-11.47676), true );

   TRY_TEST( props->get_EI12Max(nullptr), E_POINTER );
   TRY_TEST( props->get_EI12Max(&val), S_OK );
   TRY_TEST( IsEqual(val,11.47676), true );
   ...
   TRY_TEST(prop1.CoCreateInstance(CLSID_ElasticProperties), S_OK);

   CComPtr<IElasticProperties> prop2;
   TRY_TEST(prop2.CoCreateInstance(CLSID_ElasticProperties), S_OK);
