...
using PathCollectionImpl = PersistentIDCollection<CPathCollection,IPathCollection,&IID_IPathCollection,CogoObjectID,IPath>;
...
//   STDMETHOD(get__NewEnum)(/*[out, retval]*/ IUnknown** retval) override;  
   ...
   STDMETHOD(Add)(/*[in]*/ CogoObjectID id,/*[in]*/ IPath *Path) override;
