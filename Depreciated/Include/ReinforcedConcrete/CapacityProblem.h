...
struct REINFCONCCLASS rcaSectionForceDetails
{
   ...
   Float64 My;
   Float64 CompForce;
   WBFL::Geometry::Point2d LocCompForce;
   Float64 TensForce;
   WBFL::Geometry::Point2d LocTensForce;
   WBFL::Geometry::Point2d PlasticCentroid;
   WBFL::Geometry::Line2d NeutralAxis;
   Float64 Beta1;
...
public:
   ...
   CollectionIndexType AddConcreteElement(const WBFL::Geometry::Shape& shape, CollectionIndexType concreteKey, Float64 nFactor,bool bIsVoid=false);
   ...
   CollectionIndexType AddConcreteElement(const WBFL::Geometry::Shape& shape, CollectionIndexType concreteKey, bool bIsVoid = false);
   ...
   CollectionIndexType AddReinforcementElement(const WBFL::Geometry::Shape& shape, CollectionIndexType matId, Float64 initStrain = 0.);
   ...
   // cross section.
   void SetNeutralAxisLocation(const WBFL::Geometry::Line2d& line);

   //------------------------------------------------------------------------
   // GetNeutralAxisLocation
   // Retrieves the location and orientation of the neutral axis.
   void GetNeutralAxisLocation(WBFL::Geometry::Line2d* line) const;
   ...
   void GetCompressionBlockBoundary(WBFL::Geometry::Line2d* line) const;
   ...
   Float64 GetStrain( const WBFL::Geometry::Point2d& p ) const;
   ...
   Float64 GetClippedConcreteArea(const WBFL::Geometry::Line2d& clipLine, WBFL::Geometry::Line2d::Side) const;
   ...
   Float64 GetClippedConcreteArea(CollectionIndexType concreteIdx, const WBFL::Geometry::Line2d& clipLine, WBFL::Geometry::Line2d::Side) const;
   ...
   WBFL::Geometry::Rect2d GetBoundingBox() const;
...
private:
   ...
   WBFL::Geometry::Line2d  m_NeutralAxisLocation;
   ...
   mutable WBFL::EngTools::BiaxialBeamStrain m_BeamStrain; // beam strain function
   mutable Float64 m_CompArea; // area of compression block
   mutable Float64 m_EffCompArea; // area of effective compression block

   mutable WBFL::Geometry::Point2d m_PlasticCentroid;    // cache plastic centroid for efficiency
   mutable bool      m_PcHasChanged;       // update flag to facilitate caching

   mutable WBFL::Geometry::CompositeShape m_ConcreteShape; // cache shape for efficiency
