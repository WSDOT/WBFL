...
public:
   ...
   void GetNeutralAxis(WBFL::Geometry::Line2d* line) const;
   void SetNeutralAxis(const WBFL::Geometry::Line2d& line);
   ...
   void GetCompressionBlockBoundary(WBFL::Geometry::Line2d* line);
   ...
   // respectively).
   void GetForceRes(Float64* compRes, WBFL::Geometry::Point2d* compResLoc,
                    Float64* tensRes, WBFL::Geometry::Point2d* tensResLoc)const;
   void SetForceRes(Float64 compRes, const WBFL::Geometry::Point2d& compResLoc,
                    Float64 tensRes, const WBFL::Geometry::Point2d& tensResLoc);
...
private:
   ...
   Float64   m_CompRes;
   WBFL::Geometry::Point2d m_CompResLoc;
   Float64   m_TensRes;
   WBFL::Geometry::Point2d m_TensResLoc;
