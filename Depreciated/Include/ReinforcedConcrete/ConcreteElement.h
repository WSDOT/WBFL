...
public:
   ...
   rcaConcreteElement(const WBFL::Geometry::Shape& rShape, CollectionIndexType concreteIdx, Float64 nFactor,bool bIsVoid,
   ...
   rcaConcreteElement(const WBFL::Geometry::Shape& rShape, CollectionIndexType concreteIdx,bool bIsVoid,
                      const rcaCapacityProblem& rProblem);
   ...
   // by the N factor.
   Float64 GetClippedArea(const WBFL::Geometry::Line2d& clipLine, WBFL::Geometry::Line2d::Side side) const;
...
private:
   // GROUP: DATA MEMBERS
   std::unique_ptr<WBFL::Geometry::Shape> m_pShape;
