...
protected:
   ...
   //------------------------------------------------------------------------
   virtual void MakeAssignment(const rcaCapacitySolver& rOther);
...
private:
   ...
   public:
      void Init(Float64 momentAngle)
      {
         ...
         m_AntiMomentAngle = WBFL::Geometry::GeometricOperations::NormalizeAngle(momentAngle+M_PI);
   ...
   mutable WBFL::Geometry::Line2d                  m_NaLoc;  // n.a. location in section coord's
   mutable WBFL::Geometry::Point2d m_PlasticCentroid;
