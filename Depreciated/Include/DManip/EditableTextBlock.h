...
typedef enum EditableTextBlockFormatType
{
   etbfText = 1,
   etbfNumeric = 2
} EditableTextBlockFormatType;

interface iEditableTextBlock : public iTextBlock
{
   STDMETHOD_(void,EnableAutoUpdate)(BOOL bEnable) PURE;
   STDMETHOD_(BOOL,IsAutoUpdateEnabled)() PURE;
   STDMETHOD_(CString,GetEditedText)() PURE;
   STDMETHOD_(void,SetFormat)(EditableTextBlockFormatType format) PURE;
