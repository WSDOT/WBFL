...
rcaCapacitySolution rcaCapacitySolver::SolveUniaxial(rcaCapacityProblem& problem) const
{
   ...
   WBFL::Geometry::Point2d tensLoc, compLoc;
   Float64 beta1;
   Float64 cb_offset;
   ...
   try
   {
      ...
      WBFL::Geometry::Vector2d tang(1.0,m_Theta-PI_OVER_2);
      WBFL::Geometry::Line2d tna(m_PlasticCentroid, tang);
   ...
   Float64 moment_angle = WBFL::Geometry::GeometricOperations::NormalizeAngle(atan2(my,mx));
...
{
   m_MomentAngle = WBFL::Geometry::GeometricOperations::NormalizeAngle(angle);
}
