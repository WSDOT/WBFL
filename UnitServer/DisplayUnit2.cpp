...
// DisplayUnit2.cpp : Implementation of CDisplayUnit2
#include "stdafx.h"
#include "WBFLUnitServer.h"
#include "DisplayUnit2.h"
...
STDMETHODIMP CDisplayUnit::Format(double val, VARIANT_BOOL bShowUnitTag, BSTR* fmtString)
{
