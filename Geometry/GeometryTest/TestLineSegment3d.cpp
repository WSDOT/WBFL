...
// TestLineSegment3d.cpp: implementation of the CTestLineSegment3d class.
//
//////////////////////////////////////////////////////////////////////
...
CTestLineSegment3d::CTestLineSegment3d()
{

}

void CTestLineSegment3d::Test()
{
   CComPtr<ILineSegment3d> pSeg;
   TRY_TEST(pSeg.CoCreateInstance( CLSID_LineSegment3d ),S_OK);
   ...
   pSeg->putref_StartPoint(p1);
   pSeg->putref_EndPoint(p2);
   TRY_TEST(pSeg->Offset(-10,-10,0),S_OK);
   pStart.Release();
   pSeg->get_StartPoint(&pStart);
   pEnd.Release();
   pSeg->get_EndPoint(&pEnd);
