...
// TestFasterPolyShape.cpp: implementation of the CTestFasterPolyShape class.
//
//////////////////////////////////////////////////////////////////////
...
CTestFasterPolyShape::CTestFasterPolyShape()
{
...
void CTestFasterPolyShape::Test()
{
   TestIFasterPolyShape();
   TestIShape();
   TestIXYPosition();
...
void CTestFasterPolyShape::TestIFasterPolyShape()
{
   CComPtr<IFasterPolyShape> polyShape;
   TRY_TEST( polyShape.CoCreateInstance( CLSID_FasterPolyShape ), S_OK );
   ...
   pnt.Release();
   TRY_TEST( polyShape->GetPoint(-1,&x,&y),  E_INVALIDARG ); // Neg index
   TRY_TEST( polyShape->GetPoint(100,&x,&y), E_INVALIDARG ); // Index too large
   TRY_TEST( polyShape->GetPoint(3,nullptr,nullptr),   E_POINTER );
   TRY_TEST( polyShape->GetPoint(2,&x,&y),   S_OK );
   TRY_TEST( IsEqual(x,10.0), true );
   TRY_TEST( IsEqual(y,10.0), true );
...
void CTestFasterPolyShape::TestIShape()
{
   TestIShapeOpen();
   TestIShapeClosed();
   ...
   // Misc Tests
   CComPtr<IShape> shape;
   shape.CoCreateInstance( CLSID_FasterPolyShape );
   ...
   CComQIPtr<IFasterPolyShape> polyShape(shape);
   ...
   //
   CComPtr<IFasterPolyShape> diamond;
   diamond.CoCreateInstance( CLSID_FasterPolyShape );
...
void CTestFasterPolyShape::TestIShapeOpen()
{
   // Test with an open polygon
   CComPtr<IShape> shape;
   TRY_TEST( shape.CoCreateInstance( CLSID_FasterPolyShape ), S_OK );
   ...
   CComQIPtr<IFasterPolyShape> ps(clone);
...
void CTestFasterPolyShape::TestIShapeClosed()
{
...
void CTestFasterPolyShape::TestIXYPosition()
{
   CComPtr<IXYPosition> position;
   TRY_TEST( position.CoCreateInstance( CLSID_FasterPolyShape ), S_OK );

   CComQIPtr<IFasterPolyShape> polyShape(position);
...
void CTestFasterPolyShape::TestPoints(IFasterPolyShape* polyShape)
{
  CComQIPtr<IShape> shape(polyShape);
...
void CTestFasterPolyShape::TestISupportErrorInfo()
{
   CComPtr<ISupportErrorInfo> eInfo;
   TRY_TEST( eInfo.CoCreateInstance( CLSID_FasterPolyShape ), S_OK );
   TRY_TEST( eInfo != 0, true );

   // Interfaces that should be supported
   TRY_TEST( eInfo->InterfaceSupportsErrorInfo( IID_IFasterPolyShape ), S_OK );
...
void CTestFasterPolyShape::TestContains()
{
   CComPtr<IFasterPolyShape> polyShape;
   polyShape.CoCreateInstance( CLSID_FasterPolyShape );
