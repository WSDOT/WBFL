...
// TestBulbTee.cpp: implementation of the CTestBulbTee class.
//
//////////////////////////////////////////////////////////////////////
...
void CTestBulbTee::TestIBulbTee()
{
   CComPtr<IBulbTee> beam;
   TRY_TEST(beam.CoCreateInstance(CLSID_BulbTee), S_OK);
...
void CTestBulbTee::TestIShape()
{
   CComPtr<IShape> shape;
   TRY_TEST(shape.CoCreateInstance(CLSID_BulbTee), S_OK);
   ...
   box->get_Top(&val);
   TRY_TEST(IsEqual(val, 69.0), true);
   ...
   TRY_TEST(IsEqual(area, 1087.53125), true);
   TRY_TEST(IsEqual(ixx, 769358.20231312467), true);
   TRY_TEST(IsEqual(iyy, 150453.00463867188), true);
   TRY_TEST(IsEqual(ixy, 0.0), true);
   cg->get_X(&cgx);
   cg->get_Y(&cgy);
   TRY_TEST(IsEqual(cgx, 0.0), true);
   TRY_TEST(IsEqual(cgy, 38.703877642404912), true);
   ...
   TRY_TEST(IsEqual(xleft, 30.0), true);
   TRY_TEST(IsEqual(xright, 30.0), true);
   TRY_TEST(IsEqual(ytop, 69 - 38.703877642404912), true);
   TRY_TEST(IsEqual(ybottom, 38.703877642404912), true);
   ...
   TRY_TEST(IsEqual(val, 301.28393667457738), true);
...
void CTestBulbTee::TestIXYPosition()
{
   CComPtr<IXYPosition> position;
   TRY_TEST(position.CoCreateInstance(CLSID_BulbTee), S_OK);
...
void CTestBulbTee::TestISupportErrorInfo()
{
   CComPtr<ISupportErrorInfo> eInfo;
   TRY_TEST(eInfo.CoCreateInstance(CLSID_BulbTee), S_OK);
   TRY_TEST(eInfo != 0, true);

   // Interfaces that should be supported
   TRY_TEST(eInfo->InterfaceSupportsErrorInfo(IID_IBulbTee), S_OK);
