...
#ifndef __PCIDeckedIBeam_H_
#define __PCIDeckedIBeam_H_
...
private:
   ...
   // top flange points
   CComPtr<IPoint2d> m_pntLeftTop, m_pntLeftBottom, m_pntRightTop, m_pntRightBottom;
