...
#ifndef __BULBTEE2_H_
#define __BULBTEE2_H_
...
class ATL_NO_VTABLE CBulbTee2 : 
   ...
   public CProxyDPoint2dEvents< CBulbTee2 >,
   public IConnectionPointContainerImpl<CBulbTee2>
{
public:
	CBulbTee2()
	{
...
BEGIN_CONNECTION_POINT_MAP(CBulbTee2)
...
private:
   ...
   void GetHeight(Float64* pHl, Float64* pHc, Float64* pHr) const;
