...
public:
   ...
   STDMETHOD(put_VoidDiameter)(/*[in]*/Float64 d);
   STDMETHOD(get_VoidDiameter)(/*[out,retval]*/Float64* d);
   STDMETHOD(put_VoidSpacing)(/*[in]*/Float64 s);
   STDMETHOD(get_VoidSpacing)(/*[out,retval]*/Float64* s);
