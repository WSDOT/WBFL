...
// TestLineSegment2d.cpp
//
// Ported from F:\ARP\WBFL\Geometry\GeometryTest\TestLineSegment2d.cpp (legacy
...
public:
   TEST_METHOD(BasicOperations)
   {
         ...
         ASSERT_EQ(pSeg.CoCreateInstance( CLSID_LineSegment2d ),S_OK);
         ...
         ASSERT_EQ(IsEqual(length,14.1421356),true);
         ...
         pSeg->put_StartPoint(p1);
         pSeg->put_EndPoint(p2);
         ASSERT_EQ(pSeg->Offset(-10,-10),S_OK);
         pStart.Release();
         ...
         pSeg->put_StartPoint(p1);
         pSeg->put_EndPoint(p2);
         ASSERT_EQ(pSeg->Offset2(14.1421356),S_OK);
         pStart.Release();
         pSeg->get_StartPoint(&pStart);
         pEnd.Release();
         pSeg->get_EndPoint(&pEnd);
   ...
   TEST_METHOD(SupportsErrorInfo)
   {
         ...
         ASSERT_EQ( eInfo.CoCreateInstance( CLSID_LineSegment2d ), S_OK );
         ASSERT_EQ( eInfo->InterfaceSupportsErrorInfo( IID_ILineSegment2d ), S_OK );
