...
// TestBulbTee2.cpp
//
// Ported from F:\ARP\WBFL\Geometry\GeometryTest\TestBulbTee2.cpp (legacy
...
TEST_CLASS(TestBulbTee2)
{
public:
   TEST_METHOD(TestIBulbTee)
   {
         CComPtr<IBulbTee2> beam;
         ASSERT_EQ(beam.CoCreateInstance(CLSID_BulbTee2), S_OK);
         ...
         ASSERT_EQ(beam->get_n1(nullptr), E_POINTER);
         ASSERT_EQ(beam->get_n1(&val), S_OK);
         ASSERT_EQ(IsZero(val), true);

         ASSERT_EQ(beam->get_n2(nullptr), E_POINTER);
         ASSERT_EQ(beam->get_n2(&val), S_OK);
         ASSERT_EQ(IsZero(val), true);
         ...
         ASSERT_EQ(beam->put_n1(-1), S_OK);
         ASSERT_EQ(beam->put_n2(-1), S_OK);
         ...
         ASSERT_EQ(beam->put_W5(30), S_OK);
         ASSERT_EQ(beam->put_W6(30), S_OK);
         ASSERT_EQ(beam->put_T1(6.125), S_OK);
         ASSERT_EQ(beam->put_T2(6.125), S_OK);
         ASSERT_EQ(beam->put_C1(1), S_OK);
         ASSERT_EQ(beam->put_C2(15), S_OK);
         ASSERT_EQ(beam->put_n1(0.02), S_OK);
         ASSERT_EQ(beam->put_n2(-0.02), S_OK);
   ...
   {
         CComPtr<IShape> shape;
         ASSERT_EQ(shape.CoCreateInstance(CLSID_BulbTee2), S_OK);
         ...
         box->get_Top(&val);
         ASSERT_EQ(IsEqual(val, 69.9), true);
         ...
         ASSERT_EQ(IsEqual(area, 1119.03125), true);
         ASSERT_EQ(IsEqual(ixx, 798071.07781859976), true);
         ASSERT_EQ(IsEqual(iyy, 158329.51421028795), true);
         ASSERT_EQ(IsEqual(ixy, -7399.6791562527796), true);
         cg->get_X(&cgx);
         cg->get_Y(&cgy);
         ASSERT_EQ(IsEqual(cgx, -0.22117344801586084), true);
         ASSERT_EQ(IsEqual(cgy, 39.565942803019738), true);
         ...
         ASSERT_EQ(IsEqual(xleft, 29.778826551984139), true);
         ASSERT_EQ(IsEqual(xright, 30.221173448015861), true);
         ASSERT_EQ(IsEqual(ytop, 69.9 - 39.565942803019738), true);
         ASSERT_EQ(IsEqual(ybottom, 39.565942803019738), true);
         ...
         ASSERT_EQ(IsEqual(val, 301.89593547481729), true);
   ...
   {
         CComPtr<IXYPosition> position;
         ASSERT_EQ(position.CoCreateInstance(CLSID_BulbTee2), S_OK);
         ...
         hookPnt->get_Y(&y);
         ASSERT_EQ(IsEqual(x, 130.0), true);
         ASSERT_EQ(IsEqual(y, 65.05), true);
   ...
   TEST_METHOD(TestISupportErrorInfo)
   {
         ...
         ASSERT_EQ(eInfo.CoCreateInstance(CLSID_BulbTee2), S_OK);
         ASSERT_EQ(eInfo != nullptr, true);

         // Interfaces that should be supported
         ASSERT_EQ(eInfo->InterfaceSupportsErrorInfo(IID_IBulbTee2), S_OK);
