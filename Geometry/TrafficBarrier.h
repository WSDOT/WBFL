...
public:
   STDMETHOD(get_StructuredStorage)(/*[out,retval]*/IStructuredStorage2* *pStg);
	...
	STDMETHOD(get_Orientation)(/*[out, retval]*/ TrafficBarrierOrientation *pVal);
	STDMETHOD(put_Orientation)(/*[in]*/ TrafficBarrierOrientation newVal);
	STDMETHOD(get_HookPoint)(/*[out, retval]*/ IPoint2d* *pVal);
	STDMETHOD(putref_HookPoint)(/*[in]*/ IPoint2d* newVal);
	STDMETHOD(get_Y4)(/*[out, retval]*/ Float64 *pVal);
	STDMETHOD(put_Y4)(/*[in]*/ Float64 newVal);
	STDMETHOD(get_Y3)(/*[out, retval]*/ Float64 *pVal);
	STDMETHOD(put_Y3)(/*[in]*/ Float64 newVal);
	STDMETHOD(get_Y2)(/*[out, retval]*/ Float64 *pVal);
	STDMETHOD(put_Y2)(/*[in]*/ Float64 newVal);
	STDMETHOD(get_Y1)(/*[out, retval]*/ Float64 *pVal);
	STDMETHOD(put_Y1)(/*[in]*/ Float64 newVal);
	STDMETHOD(get_X5)(/*[out, retval]*/ Float64 *pVal);
	STDMETHOD(put_X5)(/*[in]*/ Float64 newVal);
	STDMETHOD(get_X4)(/*[out, retval]*/ Float64 *pVal);
	STDMETHOD(put_X4)(/*[in]*/ Float64 newVal);
	STDMETHOD(get_X3)(/*[out, retval]*/ Float64 *pVal);
	STDMETHOD(put_X3)(/*[in]*/ Float64 newVal);
	STDMETHOD(get_X2)(/*[out, retval]*/ Float64 *pVal);
	STDMETHOD(put_X2)(/*[in]*/ Float64 newVal);
	STDMETHOD(get_X1)(/*[out, retval]*/ Float64 *pVal);
	STDMETHOD(put_X1)(/*[in]*/ Float64 newVal);
