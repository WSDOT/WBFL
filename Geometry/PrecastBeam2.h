...
#ifndef __PRECASTBEAM2_H_
#define __PRECASTBEAM2_H_
...
class ATL_NO_VTABLE CPrecastBeam2 : 
   ...
   public CProxyDPoint2dEvents< CPrecastBeam2 >,
   public IConnectionPointContainerImpl<CPrecastBeam2>
{
public:
	CPrecastBeam2()
	{
...
BEGIN_CONNECTION_POINT_MAP(CPrecastBeam2)
