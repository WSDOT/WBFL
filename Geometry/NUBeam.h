...
public:
   ...
   STDMETHOD(putref_HookPoint)(/*[in]*/ IPoint2d* hookPnt);
	STDMETHOD(get_R4)(/*[out, retval]*/ Float64 *pVal);
	STDMETHOD(put_R4)(/*[in]*/ Float64 newVal);
	STDMETHOD(get_R3)(/*[out, retval]*/ Float64 *pVal);
	STDMETHOD(put_R3)(/*[in]*/ Float64 newVal);
	STDMETHOD(get_R2)(/*[out, retval]*/ Float64 *pVal);
