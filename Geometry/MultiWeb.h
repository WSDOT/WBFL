...
#ifndef __MULTIWEB_H_
#define __MULTIWEB_H_
...
class ATL_NO_VTABLE CMultiWeb : 
   ...
   public CProxyDPoint2dEvents< CMultiWeb >,
   public IConnectionPointContainerImpl<CMultiWeb>
{
public:
	CMultiWeb()
	{
...
BEGIN_CONNECTION_POINT_MAP(CMultiWeb)
...
public:
   ...
   STDMETHOD(get_WebCount)(/*[out, retval]*/ WebIndexType *pVal);
	STDMETHOD(put_WebCount)(/*[in]*/ CollectionIndexType newVal);
