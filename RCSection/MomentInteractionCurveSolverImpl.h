...
namespace WBFL
{
   namespace RCSection
   {
      class RCSCLASS MomentInteractionCurveSolverImpl
      {
      public:
         MomentInteractionCurveSolverImpl() = default;
         MomentInteractionCurveSolverImpl(const MomentInteractionCurveSolverImpl& other) = default;
         ~MomentInteractionCurveSolverImpl() = default;
         
         MomentInteractionCurveSolverImpl& operator=(const MomentInteractionCurveSolverImpl& other) = default;
