...
// TextBlockImpl.h: interface for the CTextBlockImpl class.
//
//////////////////////////////////////////////////////////////////////
...
class ATL_NO_VTABLE CTextBlockImpl : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CTextBlockImpl, &CLSID_TextBlock>,
   public CDisplayObjectDefaultImpl,
   public iTextBlock
{
public:
	CTextBlockImpl();
	virtual ~CTextBlockImpl();
...
DECLARE_REGISTRY_RESOURCEID(IDR_TEXTBLOCK)

BEGIN_COM_MAP(CTextBlockImpl)
