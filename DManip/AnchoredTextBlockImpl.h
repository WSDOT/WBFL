...
// AnchoredTextBlockImpl.h: interface for the CAnchoredTextBlockImpl class.
//
//////////////////////////////////////////////////////////////////////
...
class ATL_NO_VTABLE CAnchoredTextBlockImpl : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CAnchoredTextBlockImpl, &CLSID_AnchoredTextBlock>,
   public CDisplayObjectDefaultImpl,
   public iAnchoredTextBlock
{
public:
   CAnchoredTextBlockImpl();
	virtual ~CAnchoredTextBlockImpl();
...
DECLARE_REGISTRY_RESOURCEID(IDR_ANCHOREDTEXTBLOCK)

BEGIN_COM_MAP(CAnchoredTextBlockImpl)
	COM_INTERFACE_ENTRY(iAnchoredTextBlock)
END_COM_MAP()
   ...
   // iAnchoredTextBlock Implemention
   STDMETHOD_(void, SetLocation)(const POINT& point);
   STDMETHOD_(POINT, GetLocation)() const;
