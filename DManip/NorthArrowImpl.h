...
// NorthArrowImpl.h: interface for the CNorthArrowImpl class.
//
//////////////////////////////////////////////////////////////////////
...
class ATL_NO_VTABLE CNorthArrowImpl : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CNorthArrowImpl, &CLSID_NorthArrow>,
...
DECLARE_REGISTRY_RESOURCEID(IDR_NORTHARROW)

BEGIN_COM_MAP(CNorthArrowImpl)
	COM_INTERFACE_ENTRY(iNorthArrow)
END_COM_MAP()
   ...
   STDMETHOD_(void,SetDirection)(Float64 angle);
   STDMETHOD_(Float64,GetDirection)();

   STDMETHOD_(void,SetSize)(LONG size);
