...
bool TestGrade(WBFL::Debug::Log& rlog, const Profile& profile, Float64 results[], long minStation=440, long maxStation=1560, long inc=160);
bool TestCrownSlopes(WBFL::Debug::Log& rlog, const Profile& profile, IndexType surfaceIdx, IndexType ridgePointIdx, Float64 results[][2], long minStation = 440, long maxStation = 1560, long inc = 160);
bool TestElevation(WBFL::Debug::Log& rlog, const Profile& profile, IndexType surfaceIdx, Float64 offset, Float64 results[], long minStation = 440, long maxStation = 1560, long inc = 160);

bool Profile::TestMe(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile");
   ...
   TRY_TESTME(Test8(rlog));
   TRY_TESTME(Test9(rlog));
   TRY_TESTME(Test10(rlog));
   TRY_TESTME(Test11(rlog));
   TRY_TESTME(Test12(rlog));
   TRY_TESTME(Test13(rlog));
   TRY_TESTME(Test14(rlog));
   TRY_TESTME(Test15(rlog));
   TRY_TESTME(Test16(rlog));
   TESTME_EPILOG("Profile");
}

bool Profile::Test1(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile::Test1");
   ...
   TRY_TESTME(profile->GetProfileElementCount() == 2);

   TRY_TESTME(profile->GetProfileElement(0) == segment);
   TRY_TESTME(profile->GetProfileElement(1) == vc);

   profile->ClearProfileElements();
   TRY_TESTME(profile->GetProfileElementCount() == 0);
   ...
   TESTME_EPILOG("Profile::Test1");
}

bool Profile::Test2(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile::Test2");
   ...
   TRY_TESTME(TestGrade(rlog, *profile, Grades));
   ...
   TRY_TESTME(TestCrownSlopes(rlog, *profile, 0, 2, CrownSlopes1));
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, -15, ElevA));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -5, ElevB));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -2, ElevC));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 0, ElevD));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 5, ElevE));
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, -5, ElevF));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 0, ElevG));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 2, ElevH));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 5, ElevI));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 15, ElevJ));
   ...
   TRY_TESTME(TestCrownSlopes(rlog, *profile, 0, 2, CrownSlopes2));
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, -15, ElevK));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -5, ElevL));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -2, ElevM));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 0, ElevN));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 5, ElevO));
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, -5, ElevP));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 0, ElevQ));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 2, ElevR));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 5, ElevS));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 15, ElevT));

   TESTME_EPILOG("Profile::Test2");
}

bool Profile::Test3(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile::Test3");
   //
   // Test Elevation and Grade
   //
   //
   ...
   TESTME_EPILOG("Profile::Test3");
}

bool Profile::Test4(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile::Test4");
   ...
   TESTME_EPILOG("Profile::Test4");
}

bool Profile::Test5(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile::Test5");
   //
   // Test Elevation and Grade
   //
   //
   ...
   TESTME_EPILOG("Profile::Test5");
}

bool Profile::Test6(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile::Test6");
   //
   // Test Elevation and Grade
   //
   //
   ...
   TESTME_EPILOG("Profile::Test6");
}

bool Profile::Test7(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile::Test7");
   ...
   TRY_TESTME(IsEqual(profile->Elevation(100.00), 0.0));
   TRY_TESTME(IsEqual(profile->Grade(100.00), 0.0));
   ...
   TRY_TESTME(IsEqual(profile->CrossSlope(surface, 0.0, -10), 0.02));
   TRY_TESTME(IsEqual(profile->CrossSlope(surface, 0.0, 10), -0.02));

   TRY_TESTME(IsEqual(profile->CrossSlope(surface, 50.0, -10), 0.02));
   TRY_TESTME(IsEqual(profile->CrossSlope(surface, 50.0, 10), -0.02));

   TRY_TESTME(IsEqual(profile->CrossSlope(surface, 75.0, -10), 0.03));
   TRY_TESTME(IsEqual(profile->CrossSlope(surface, 75.0, 10), -0.03));

   TRY_TESTME(IsEqual(profile->CrossSlope(surface, 100., -10), 0.04));
   TRY_TESTME(IsEqual(profile->CrossSlope(surface, 100., 10), -0.04));

   TRY_TESTME(IsEqual(profile->CrossSlope(surface, 150.0, -10), 0.04));
   TRY_TESTME(IsEqual(profile->CrossSlope(surface, 150.0, 10), -0.04));

   TESTME_EPILOG("Profile::Test7");
}

bool Profile::Test8(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile::Test8");
   ...
   TRY_TESTME(IsEqual(profile->Elevation(100.0),100.0));
   TRY_TESTME(IsZero(profile->Grade(100.0)));
   ...
   TESTME_EPILOG("Profile::Test8");
}

bool Profile::Test9(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile::Test9");
   ...
   TRY_TESTME(IsEqual(profile->Elevation(4700), 437.84));
   TRY_TESTME(IsEqual(profile->Elevation(4850), 436.34));
   TRY_TESTME(IsEqual(profile->Elevation(4900), 435.89));
   TRY_TESTME(IsEqual(profile->Elevation(5000), 435.29));
   TRY_TESTME(IsEqual(profile->Elevation(5100), 435.09));
   TRY_TESTME(IsEqual(profile->Elevation(5200), 435.29));
   TRY_TESTME(IsEqual(profile->Elevation(5300), 435.89));
   TRY_TESTME(IsEqual(profile->Elevation(5400), 436.89));
   TRY_TESTME(IsEqual(profile->Elevation(5500), 438.29));
   TRY_TESTME(IsEqual(profile->Elevation(5600), 440.09));
   TRY_TESTME(IsEqual(profile->Elevation(5650), 441.14));
   TRY_TESTME(IsEqual(profile->Elevation(6000), 448.84));

   TESTME_EPILOG("Profile::Test9");
}

bool Profile::Test10(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile::Test10");
   // Test a profile with one vertical curve element
   auto alignment = Alignment::Create();
   auto profile = Profile::Create();
   alignment->AddProfile(0, profile);
   ...
   TRY_TESTME(IsEqual(profile->Elevation(surface, 100, 0.0), 100.00));
   TRY_TESTME(IsEqual(profile->Elevation(surface, 100, 5.0), 99.80));
   TRY_TESTME(IsEqual(profile->Elevation(surface, 100,-5.0), 99.90));

   TESTME_EPILOG("Profile::Test10");
}

bool Profile::Test11(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile::Test11");
   ...
   TRY_TESTME(IsEqual(profile->Elevation(250), 72.5));
   TRY_TESTME(IsEqual(profile->Elevation(450), 57.5));
   TRY_TESTME(IsEqual(profile->Elevation(650), 72.5));

   TESTME_EPILOG("Profile::Test11");
}

bool Profile::Test12(WBFL::Debug::Log& rlog)
{
   // Same as Test2, except stations are defined using local station value and stationing zones (Test2 uses normalized values)
   TESTME_PROLOGUE("Profile::Test12");
   auto alignment = Alignment::Create();
   auto profile = Profile::Create();
   alignment->AddProfile(0, profile);
   ...
   TESTME_EPILOG("Profile::Test12");
}

bool Profile::Test13(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile::Test13");
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, 0, ElevA));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -10, ElevB));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 10, ElevB));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -30, ElevC));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 30, ElevC));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -40, ElevC));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 40, ElevC));
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, -30, ElevC));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 30, ElevC));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -40, ElevD));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 40, ElevC));
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, -10, ElevB));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 10, ElevB));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -30, ElevE));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 30, ElevE));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -60, ElevF));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 60, ElevF));
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, -10, ElevB));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 10, ElevB));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -30, ElevG));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 30, ElevG));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -60, ElevG));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 60, ElevG));
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, -10, ElevB));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 10, ElevB));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -30, ElevH));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 30, ElevH));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -60, ElevH));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 60, ElevH));

   TESTME_EPILOG("Profile::Test13");
}

bool Profile::Test14(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile::Test14");
   auto alignment = Alignment::Create();
   auto profile = Profile::Create();
   alignment->AddProfile(0, profile);
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, 0, ElevA));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -20, ElevB));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 20, ElevB));
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, 0, ElevC));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -20, ElevD));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 20, ElevB)); // pivot on right edge... elevations don't change
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, 0, ElevA)); // pivot on CL... elevations don't change
   TRY_TESTME(TestElevation(rlog, *profile, 0, -20, ElevE));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 20, ElevF));
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, 0, ElevG));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -20, ElevB)); // pivot on left edge... elevations don't change
   TRY_TESTME(TestElevation(rlog, *profile, 0, 20, ElevH));
   ...
   TESTME_EPILOG("Profile::Test14");
}

bool Profile::Test15(WBFL::Debug::Log& rlog)
{
   TESTME_PROLOGUE("Profile::Test15");
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, 0, ElevC, 425, 1025, 100));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -20, ElevD, 425, 1025, 100));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 20, ElevB, 425, 1025, 100)); // pivot on right edge... elevations don't change
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, 0, ElevE));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -20, ElevF));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 20, ElevB)); // pivot on right edge... elevations don't change
   ...
   TRY_TESTME(TestElevation(rlog, *profile, 0, 0, ElevG, 425, 1025, 100));
   TRY_TESTME(TestElevation(rlog, *profile, 0, -20, ElevH, 425, 1025, 100));
   TRY_TESTME(TestElevation(rlog, *profile, 0, 20, ElevB, 425, 1025, 100)); // pivot on right edge... elevations don't change
   ...
   catch (XCoordGeom& e) { TRY_TESTME(e.GetReason() == WBFL_COGO_E_SUPERTRANSITIONERROR); }
...
{
   TESTME_PROLOGUE("Profile::Test16");
   ...
   for (int i = 0; i < 50; i++)
   {
      ...
      TRY_TESTME(station == std::get<0>(vResults1[i]));
      TRY_TESTME(IsEqual(std::get<1>(vResults1[i]), elevL));
      TRY_TESTME(IsEqual(std::get<2>(vResults1[i]), elevP));
      TRY_TESTME(IsEqual(std::get<3>(vResults1[i]), elevR));
   }
   ...
   for (int i = 0; i < 50; i++)
   {
      ...
      TRY_TESTME(station == std::get<0>(vResults2[i]));
      TRY_TESTME(IsEqual(std::get<1>(vResults2[i]), elevL));
      TRY_TESTME(IsEqual(std::get<2>(vResults2[i]), elevP));
      TRY_TESTME(IsEqual(std::get<3>(vResults2[i]), elevR));
   }
   ...
   for (int i = 0; i < 50; i++)
   {
      ...
      TRY_TESTME(station == std::get<0>(vResults3[i]));
      TRY_TESTME(IsEqual(std::get<1>(vResults3[i]), elevL));
      TRY_TESTME(IsEqual(std::get<2>(vResults3[i]), elevP));
      TRY_TESTME(IsEqual(std::get<3>(vResults3[i]), elevR));
   }

   TESTME_EPILOG("Profile::Test16");
}

bool TestGrade(WBFL::Debug::Log& rlog, const Profile& profile,  Float64 results[], long minStation, long maxStation, long inc)
{
   TESTME_PROLOGUE("TestGrade");
   ...
   for (long i = minStation; i <= maxStation; i += inc, j++)
   {
      ...
      TRY_TESTME(IsEqual(grade * 100, results[j]));
      CHECK(IsEqual(grade * 100, results[j]));
   }
   TESTME_EPILOG("TestGrade");
}

#include <iomanip>
bool TestElevation(WBFL::Debug::Log& rlog,const Profile& profile, IndexType surfaceIdx, Float64 offset, Float64 results[], long minStation, long maxStation, long inc)
{
   TESTME_PROLOGUE("TestElevation");
   auto alignment = profile.GetAlignment();
   long j = 0;
   for (long i = minStation; i <= maxStation; i += inc, j++)
   {
      ...
      TRY_TESTME(IsEqual(elevation, results[j]));
      //std::cout << std::fixed << std::setprecision(5);
      //std::cout << elevation << ", " << results[j] << std::endl;
   }
   //std::cout << std::endl;
   TESTME_EPILOG("TestElevation");
}

bool TestCrownSlopes(WBFL::Debug::Log& rlog, const Profile& profile, IndexType surfaceIdx, IndexType ridgePointIdx, Float64 results[][2], long minStation, long maxStation, long inc)
{
   TESTME_PROLOGUE("TestCrownSlopes");
   auto alignment = profile.GetAlignment();
   ...
   for (long i = minStation; i <= maxStation; i += inc, j++)
   {
      ...
      TRY_TESTME(IsEqual(left, results[j][0]));
      CHECK(IsEqual(left, results[j][0]));

      TRY_TESTME(IsEqual(right, results[j][1]));
      CHECK(IsEqual(right, results[j][1]));
   }
   TESTME_EPILOG("TestCrownSlopes");
}
#endif // _UNITTEST
