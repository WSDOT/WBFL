...
public:
   STDMETHOD(OnLoadCaseChanged)(/*[in]*/ ILoadCase*  LoadCase, ChangeType change);
   STDMETHOD(OnLoadCaseRenamed)(/*[in]*/ BSTR oldName, BSTR newName);

   STDMETHOD(OnLoadCasesChanged)(/*[in]*/ILoadCase* LoadCase, ChangeType change);
   STDMETHOD(OnLoadCasesRenamed)(/*[in]*/BSTR oldName, /*[in]*/BSTR newName);
   STDMETHOD(OnLoadCasesAdded)(/*[in]*/ILoadCase* load);
   STDMETHOD(OnLoadCasesBeforeRemove)(/*[in]*/ILoadCase* load);

   HRESULT OnCreateSegment(ILoadCase* pLoadCase);
