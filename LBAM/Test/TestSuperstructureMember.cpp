...
void CTestSuperstructureMember::Test()
{
   ...
   TRY_TEST( d, 0.0 );
   MemberReleaseType mr;
   CComBSTR relStage;
   TRY_TEST( psm->GetEndRelease(ssLeft, &relStage, &mr), S_OK );
   TRY_TEST( mr, mrtNone );
   TRY_TEST( relStage.Length(), 0 );
   relStage.Empty();
   TRY_TEST( psm->GetEndRelease(ssRight, &relStage, &mr), S_OK );
   TRY_TEST( mr, mrtNone );
   TRY_TEST( relStage.Length(), 0 );
   ...
   TRY_TEST( psm->get_Length(&d), S_OK );
   TRY_TEST( d, 12.3 );
   TRY_TEST( psm->SetEndRelease(ssLeft, CComBSTR("Stage 2"), mrtPinned), S_OK );
   TEST_STIFFNESS_FIRED();
   relStage.Empty();
   TRY_TEST( psm->GetEndRelease(ssLeft, &relStage, &mr), S_OK );
   TRY_TEST( mr, mrtPinned );
   TRY_TEST( relStage, "Stage 2" );
   TRY_TEST( psm->SetEndRelease(ssLeft, CComBSTR("Stage 3"), mrtPinned), S_OK );
   TEST_STIFFNESS_FIRED();
   relStage.Empty();
   TRY_TEST( psm->GetEndRelease(ssLeft, &relStage, &mr), S_OK );
   TRY_TEST( mr, mrtPinned );
   ...
   relStage.Empty();
   TRY_TEST( psm->SetEndRelease(ssRight, CComBSTR("Stage 2"), mrtPinned), S_OK );
   TEST_STIFFNESS_FIRED();
   relStage.Empty();
   TRY_TEST( psm->GetEndRelease(ssRight, &relStage, &mr), S_OK );
   TRY_TEST( mr, mrtPinned );
   TRY_TEST( relStage, "Stage 2" );
   TRY_TEST( psm->SetEndRelease(ssRight, CComBSTR("Stage 4"), mrtPinned), S_OK );
   TEST_STIFFNESS_FIRED();
   relStage.Empty();
   TRY_TEST( psm->GetEndRelease(ssRight, &relStage, &mr), S_OK );
   TRY_TEST( relStage, "Stage 4" );
   TRY_TEST( mr, mrtPinned );
   TRY_TEST( psm->SetEndRelease(ssRight, CComBSTR("Stage 4"), mrtNone), S_OK );
   TEST_STIFFNESS_FIRED();
   relStage.Empty();
   TRY_TEST( psm->GetEndRelease(ssRight, &relStage, &mr), S_OK );
   TRY_TEST( relStage, "Stage 4" );
