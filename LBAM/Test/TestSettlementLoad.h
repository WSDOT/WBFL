...
public:
   ...
   STDMETHOD(OnSettlementLoadsChanged)(/*[in]*/ISettlementLoadItem* SettlementLoad);
   STDMETHOD(OnSettlementLoadsAdded)(/*[in]*/ISettlementLoadItem* SettlementLoad);
   STDMETHOD(OnSettlementLoadsBeforeRemove)(/*[in]*/ISettlementLoadItem* SettlementLoad);
