...
STDMETHODIMP CLoadGroups::OnLoadGroupChanged(/*[in]*/ILoadGroup* pLoadGroup, ChangeType change)
{
...
HRESULT CLoadGroups::OnBeforeAdd( StoredType* pVal)
{
   ...
   try
   {
      ...
      HRESULT hr;
      hr = CrAdvise(pVal->second.m_T, this, IID_ILoadGroupEvents, &(pVal->first));
      if (FAILED(hr))
         return hr;
   }
   catch(...)
...
HRESULT CLoadGroups::OnBeforeRemove ( StoredType* pVal)
{
   try
   {
      ...
      HRESULT hr;
      hr = CrUnadvise(pVal->second.m_T, this, IID_ILoadGroupEvents, pVal->first);
      if (FAILED(hr))
         return hr;
   }
   catch(...)
...
STDMETHODIMP CLoadGroups::Clone(ILoadGroups* *pColl)
{
   CHECK_RETOBJ(pColl);
   ...
   CComPtr<ILoadGroups> spisms(pnew);
