...
// TestLoadCombinationContext.h: interface for the TestLoadCombinationContext class.
//
//////////////////////////////////////////////////////////////////////
...
public:
	TestLoadCombinationContext();
	virtual ~TestLoadCombinationContext();

	static void Test();

BEGIN_COM_MAP(TestLoadCombinationContext)
