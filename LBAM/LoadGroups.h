...
class CLoadGroups;
using LoadGroupCollImpl = CComBSTRKeyedCollection<ILoadGroups, ILoadGroup, IEnumLoadGroup, &IID_IEnumLoadGroup, IndexType>;
...
// ILoadGroupEvents
   STDMETHOD(OnLoadGroupChanged)(/*[in]*/ILoadGroup* LoadGroup,ChangeType type) override;
   STDMETHOD(OnLoadGroupRenamed)(BSTR oldNam, BSTR newNam) override;

// ILoadGroups
public:
	STDMETHOD(Clone)(/*[out, retval]*/ ILoadGroups** clone) override;
