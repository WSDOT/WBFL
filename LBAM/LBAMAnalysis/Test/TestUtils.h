...
static void DumpSectionForceResults(std::ofstream& os, ILongArray* pois , CComPtr<ISectionResult3Ds> pres, std::vector<Float64>& poi_locs)
{
...
static void DumpDeflectionResults(std::ofstream& os, ILongArray* pois , CComPtr<ISectionResult3Ds> pres, std::vector<Float64>& poi_locs)
{
   CollectionIndexType poi_cnt;
   pois->get_Count(&poi_cnt);
...
static void DumpSupportDeflectionResults(std::ofstream& os, ILongArray* pois , CComPtr<IResult3Ds> pres)
{
   CollectionIndexType poi_cnt;
   pois->get_Count(&poi_cnt);
...
static void DumpReactionResults(std::ofstream& os, ILongArray* pois , CComPtr<IResult3Ds> pres)
{
   // have to attach and detach variant to safearray
   CollectionIndexType poi_cnt;
   pois->get_Count(&poi_cnt);
...
static void DumpStressResults(std::ofstream& os, ILongArray* pois , CComPtr<ISectionStressResults> pres)
{
   CollectionIndexType poi_cnt;
   pois->get_Count(&poi_cnt);
   for (CollectionIndexType i=0; i<poi_cnt; i++)
