...
// LoadGroupDeflectionResponse.cpp : Implementation of CLoadGroupDeflectionResponse
#include "stdafx.h"
...
STDMETHODIMP CLoadGroupDeflectionResponse::InterfaceSupportsErrorInfo(REFIID riid)
{
