...
public:
   ...
   STDMETHOD(GetLiveLoadModelCount)(/*[out, retval]*/ IndexType *pVal) override;
   STDMETHOD(GetLiveLoadModel)(/*[in]*/IndexType index,/*[out, retval]*/ LiveLoadModelType *pVal) override;
	STDMETHOD(AddLiveLoadModel)(/*[in]*/ LiveLoadModelType newVal) override;
   STDMETHOD(RemoveLiveLoadModel)(/*[in]*/IndexType index) override;
