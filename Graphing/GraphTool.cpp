...
bool GraphTool::TextOutRotated(HDC hDC, LONG x, LONG y, LONG rotation, 
...
HFONT GraphTool::CreateRotatedFont(HDC hDC, LONG rotation, LONG nPointSize, LPCTSTR lpszFaceName)
{
   CHECK(hDC!=nullptr);
...
void GraphTool::DrawRect(HDC hDC, const PointMapper& mapper, const Rect& rect,
                           ...
                           bool doFill, COLORREF fillColor)
{
   ...
   Point bottom_right = rect.BottomRight();
