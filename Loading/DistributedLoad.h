...
public:
	...
	STDMETHOD(get_Direction)(/*[out, retval]*/ ldLoadDirection *pVal) override;
	STDMETHOD(put_Direction)(/*[in]*/ ldLoadDirection newVal) override;
	STDMETHOD(get_Orientation)(/*[out, retval]*/ ldLoadOrientation *pVal) override;
	STDMETHOD(put_Orientation)(/*[in]*/ ldLoadOrientation newVal) override;
...
//	STDMETHOD(put_MemberType)(/*[in]*/ MemberType newVal) override;
	STDMETHOD(Clone)(/*[out,retval]*/ldIDistributedLoad** clone) override;
