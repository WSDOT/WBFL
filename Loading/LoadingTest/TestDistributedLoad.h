...
public ldIDistributedLoadsEvents
{
public:
	static void Test();
...
BEGIN_COM_MAP(CTestDistributedLoad)
  ...
  COM_INTERFACE_ENTRY(ldIDistributedLoadsEvents)
END_COM_MAP()

public:
   STDMETHOD(OnDistributedLoadChanged)(/*[in]*/ldIDistributedLoad* DistributedLoad);
   STDMETHOD(OnDistributedLoadsChanged)(/*[in]*/ldIDistributedLoadItem* DistributedLoad);
   STDMETHOD(OnDistributedLoadsAdded)(/*[in]*/ldIDistributedLoadItem* DistributedLoad);
   STDMETHOD(OnDistributedLoadsBeforeRemove)(/*[in]*/ldIDistributedLoadItem* DistributedLoad);
