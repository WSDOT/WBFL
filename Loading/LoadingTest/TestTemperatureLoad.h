...
public ldITemperatureLoadsEvents
{
public:
	static void Test();
...
BEGIN_COM_MAP(CTestTemperatureLoad)
  ...
  COM_INTERFACE_ENTRY(ldITemperatureLoadsEvents)
END_COM_MAP()

public:
   STDMETHOD(OnTemperatureLoadChanged)(/*[in]*/ldITemperatureLoad* TemperatureLoad);
   STDMETHOD(OnTemperatureLoadsChanged)(/*[in]*/ldITemperatureLoadItem* TemperatureLoad);
   STDMETHOD(OnTemperatureLoadsAdded)(/*[in]*/ldITemperatureLoadItem* TemperatureLoad);
   STDMETHOD(OnTemperatureLoadsBeforeRemove)(/*[in]*/ldITemperatureLoadItem* TemperatureLoad);
