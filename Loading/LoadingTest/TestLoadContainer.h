...
template <class T , class TItem,   class TIContainer, 
...
static HRESULT TestContainer(TListen* pMe, const CLSID& clsid, const CLSID& containerCLSID )
{
   ...
   TRY_TEST( pss0.CoCreateInstance( clsid ) , S_OK );
   TRY_TEST( pss0->put_MemberID(0) , S_OK );
   TRY_TEST( pss1.CoCreateInstance( clsid ) , S_OK );
   TRY_TEST( pss1->put_MemberID(1) , S_OK );
   TRY_TEST( pss2.CoCreateInstance( clsid ) , S_OK );
   TRY_TEST( pss2->put_MemberID(2) , S_OK );
   TRY_TEST( pss3.CoCreateInstance( clsid ) , S_OK );
   TRY_TEST( pss3->put_MemberID(3) , S_OK );
   TRY_TEST( pss4.CoCreateInstance( clsid ) , S_OK );
   TRY_TEST( pss4->put_MemberID(4) , S_OK );
   TRY_TEST( pss5.CoCreateInstance( clsid ) , S_OK );
   TRY_TEST( pss5->put_MemberID(5) , S_OK );
   TRY_TEST( pss6.CoCreateInstance( clsid ) , S_OK );
   ...
   TRY_TEST( pcnt1->Add(CComBSTR("Stage1"), CComBSTR("LoadGroup 1"), pss0) , S_OK );
   TEST_CONTAINER_FIRED();
   TRY_TEST( pcnt1->get_Count(&cnt) , S_OK );
   TRY_TEST(cnt, 1);
   TRY_TEST( pcnt1->Add(CComBSTR("Stage1"), CComBSTR("LoadGroup 1"), pss1) , S_OK );
   TEST_CONTAINER_FIRED();
   TRY_TEST( pcnt1->get_Count(&cnt) , S_OK );
   TRY_TEST(cnt, 2);
   TRY_TEST( pcnt1->Add(CComBSTR("Stage1"), CComBSTR("LoadGroup 1"), pss2) , S_OK );
   TEST_CONTAINER_FIRED();
   TRY_TEST( pcnt1->get_Count(&cnt) , S_OK );
   TRY_TEST(cnt, 3);
   TRY_TEST( pcnt1->Add(CComBSTR("Stage2"), CComBSTR("LoadGroup 1"), pss3) , S_OK );
   TEST_CONTAINER_FIRED();
   TRY_TEST( pcnt1->get_Count(&cnt) , S_OK );
   TRY_TEST(cnt, 4);
   TRY_TEST( pcnt1->Add(CComBSTR("Stage2"), CComBSTR("LoadGroup 2"), pss4) , S_OK );
   TEST_CONTAINER_FIRED();
   TRY_TEST( pcnt1->get_Count(&cnt) , S_OK );
   TRY_TEST(cnt, 5);
   TRY_TEST( pcnt1->Add(CComBSTR("Stage3"), CComBSTR("LoadGroup 1"), pss5) , S_OK );
   TEST_CONTAINER_FIRED();
   TRY_TEST( pcnt1->get_Count(&cnt) , S_OK );
   TRY_TEST(cnt, 6);
   TRY_TEST( pcnt1->Add(CComBSTR("Stage1"), CComBSTR("LoadGroup 2"), pss6) , S_OK );
   TEST_CONTAINER_FIRED();
   TRY_TEST( pcnt1->get_Count(&cnt) , S_OK );
   TRY_TEST(cnt, 7);
...

   {
      ...
      TRY_TEST(pcnt2.CoCreateInstance( containerCLSID ), S_OK );
