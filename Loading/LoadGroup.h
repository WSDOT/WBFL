...
//   public CComRefCountTracer<CLoadGroup,CComObjectRootEx<CComSingleThreadModel> >,
	public CComCoClass<CLoadGroup, &CLSID_ldLoadGroup>,
...
BEGIN_COM_MAP(CLoadGroup)
	COM_INTERFACE_ENTRY(ldILoadGroup)
...
CONNECTION_POINT_ENTRY(IID_ldILoadGroupEvents)
...
public:
	...
	STDMETHOD(Clone)(/*[out,retval]*/ldILoadGroup** clone) override;
