...
class CLoadGroups;
using LoadGroupCollImpl = CComBSTRKeyedCollection<ldILoadGroups, ldILoadGroup, ldIEnumLoadGroup, &IID_ldIEnumLoadGroup, CollectionIndexType>;
...
// ldILoadGroupEvents
   STDMETHOD(OnLoadGroupChanged)(/*[in]*/ldILoadGroup* LoadGroup,ldLoadingChangeType type) override;
   STDMETHOD(OnLoadGroupRenamed)(BSTR oldNam, BSTR newNam) override;

// ldILoadGroups
public:
	STDMETHOD(Clone)(/*[out, retval]*/ ldILoadGroups** clone) override;
