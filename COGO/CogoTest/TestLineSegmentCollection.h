...
public:
	STDMETHOD(OnLineSegmentChanged)(CogoElementKey key,ILineSegment2d* lineSeg);
	STDMETHOD(OnLineSegmentAdded)(CogoElementKey key,ILineSegment2d* lineSeg);
	STDMETHOD(OnLineSegmentRemoved)(CogoElementKey key);
