...
public:
	STDMETHOD(OnProfilePointChanged)(CogoElementKey key,IProfilePoint* pp);
	STDMETHOD(OnProfilePointAdded)(CogoElementKey key,IProfilePoint* pp);
	STDMETHOD(OnProfilePointRemoved)(CogoElementKey key);
