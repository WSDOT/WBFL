...
class CProxyDPathCollectionEvents : public IConnectionPointImpl<T, &IID_IPathCollectionEvents, CComDynamicUnkArray>
{
	//Warning this class may be recreated by the wizard.
public:
	VOID Fire_OnPathChanged(IPathCollection* coll,LONG key, IPath * Path)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnPathAdded(IPathCollection* coll,LONG key, IPath * Path)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnPathRemoved(IPathCollection* coll,LONG key)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
...
class CProxyDCogoModelEvents : public IConnectionPointImpl<T, &IID_ICogoModelEvents, CComDynamicUnkArray>
{
	//Warning this class may be recreated by the wizard.
public:
	VOID Fire_OnPointChanged(ICogoModel * cm, LONG key, IPoint2d * point)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnPointAdded(ICogoModel * cm, LONG key, IPoint2d * point)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnPointRemoved(ICogoModel * cm, LONG key)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnLineSegmentChanged(ICogoModel * cm, LONG key, ILineSegment2d * lineSeg)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnLineSegmentAdded(ICogoModel * cm, LONG key, ILineSegment2d * lineSeg)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnLineSegmentRemoved(ICogoModel * cm, LONG key)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnProfilePointChanged(ICogoModel * cm, LONG key, IProfilePoint * pp)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnProfilePointAdded(ICogoModel * cm, LONG key, IProfilePoint * pp)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnProfilePointRemoved(ICogoModel * cm, LONG key)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnVertCurveChanged(ICogoModel * cm, LONG key, IVertCurve * vc)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnVertCurveAdded(ICogoModel * cm, LONG key, IVertCurve * vc)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnVertCurveRemoved(ICogoModel * cm, LONG key)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnHorzCurveChanged(ICogoModel * cm, LONG key, IHorzCurve * vc)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnHorzCurveAdded(ICogoModel * cm, LONG key, IHorzCurve * vc)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnHorzCurveRemoved(ICogoModel * cm, LONG key)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnAlignmentChanged(ICogoModel * cm, LONG key, IAlignment * alignment)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnAlignmentAdded(ICogoModel * cm, LONG key, IAlignment * alignment)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnAlignmentRemoved(ICogoModel * cm, LONG key)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnPathChanged(ICogoModel * cm, LONG key, IPath * path)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnPathAdded(ICogoModel * cm, LONG key, IPath * path)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnPathRemoved(ICogoModel * cm, LONG key)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
...
class CProxyDHorzCurveCollectionEvents : public IConnectionPointImpl<T, &IID_IHorzCurveCollectionEvents, CComDynamicUnkArray>
{
	//Warning this class may be recreated by the wizard.
public:
	VOID Fire_OnHorzCurveChanged(LONG key, IHorzCurve * vc)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnHorzCurveAdded(LONG key, IHorzCurve * vc)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnHorzCurveRemoved(LONG key)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
...
class CProxyDLineSegmentCollectionEvents : public IConnectionPointImpl<T, &IID_ILineSegmentCollectionEvents, CComDynamicUnkArray>
{
	//Warning this class may be recreated by the wizard.
public:
	VOID Fire_OnLineSegmentChanged(LONG key, ILineSegment2d * lineSeg)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnLineSegmentAdded(LONG key, ILineSegment2d * lineSeg)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnLineSegmentRemoved(LONG key)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
...
class CProxyDProfilePointCollectionEvents : public IConnectionPointImpl<T, &IID_IProfilePointCollectionEvents, CComDynamicUnkArray>
{
	//Warning this class may be recreated by the wizard.
public:
	VOID Fire_OnProfilePointChanged(LONG key, IProfilePoint * pp)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnProfilePointAdded(LONG key, IProfilePoint * pp)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnProfilePointRemoved(LONG key)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
...
class CProxyDVertCurveCollectionEvents : public IConnectionPointImpl<T, &IID_IVertCurveCollectionEvents, CComDynamicUnkArray>
{
	//Warning this class may be recreated by the wizard.
public:
	VOID Fire_OnVertCurveChanged(LONG key, IVertCurve * vc)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnVertCurveAdded(LONG key, IVertCurve * vc)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnVertCurveRemoved(LONG key)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
...
class CProxyDPointCollectionEvents : public IConnectionPointImpl<T, &IID_IPointCollectionEvents, CComDynamicUnkArray>
{
	//Warning this class may be recreated by the wizard.
public:
	VOID Fire_OnPointChanged(LONG key, IPoint2d * point)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnPointAdded(LONG key, IPoint2d * point)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
	...
	VOID Fire_OnPointRemoved(LONG key)
	{
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
		int nConnections = m_vec.GetSize();
