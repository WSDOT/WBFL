...
//
//std::unique_ptr<UniformFDMesh> FDMeshGenerator::GenerateMesh(IShape* pShape, bool bIgnoreSymmetry) const
//{
...
//void FDMeshGenerator::GenerateMeshRow(IndexType row, IndexType Nx, Float64 dx, Float64 dy, Float64 tlx, Float64 tly, IShape* pShape, std::unique_ptr<UniformFDMesh>& mesh)
//{
