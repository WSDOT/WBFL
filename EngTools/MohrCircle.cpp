...
bool MohrCircle::TestMe(WBFL::Debug::Log& rlog)
{
   ...
   TRY_TESTME(IsEqual(c1.GetPrincipalDirection(), ToRadians(-28.15), 0.01));
   ...
   TRY_TESTME(IsEqual(c3.GetPrincipalDirection(), ToRadians(19.33), 0.1));
   ...
   TRY_TESTME(IsEqual(c5.GetPrincipalDirection(), ToRadians(30.96), 0.01));
   ...
   TRY_TESTME(IsEqual(c6.GetPrincipalDirection(), ToRadians(-33.7), 0.1));
   ...
   TRY_TESTME(IsEqual(c7.GetPrincipalDirection(), ToRadians(-26.56), 0.1));

   MohrCircle c8(4.18, 3.25, 2.87);
   TRY_TESTME(IsEqual(c8.GetSmax(), 6.63, 0.1));
   TRY_TESTME(IsEqual(c8.GetSmin(), 0.81, 0.1));
   TRY_TESTME(IsEqual(c8.GetPrincipalDirection(), ToRadians(-40.4), 0.1));
