...
rcaCapacitySolution::rcaCapacitySolution()
{
   ...
   m_My                   = 0.0;
   m_Beta1                = 0.0;
   m_NaLine               = gpLine2d(0.0,gpVector2d(1.0,PI_OVER_2));
   m_CompFiberDist        = 0.0;
   m_CompBlockOffset      = 0.0;
   m_AreaAboveNeutralAxis = 0.0;
   m_CompBlockArea        = 0.0;
   m_CompRes              = 0.0;
   m_CompResLoc           = gpPoint2d(0.0,0.0);
   m_TensRes              = 0.0;
   m_TensResLoc           = gpPoint2d(0.0,0.0);
}
...
void rcaCapacitySolution::GetNeutralAxis(gpLine2d* line) const
{
   *line = m_NaLine;
}

void rcaCapacitySolution::SetNeutralAxis(const gpLine2d& line)
{
   m_NaLine = line;
}
...
void rcaCapacitySolution::GetCompressionBlockBoundary(gpLine2d* line)
{
   *line = m_NaLine.Parallel(m_CompBlockOffset, gpLine2d::Left);
}
...
void rcaCapacitySolution::GetForceRes(Float64* compRes, gpPoint2d* compResLoc, 
...
void rcaCapacitySolution::SetForceRes(Float64 compRes, const gpPoint2d& compResLoc, 
                                      Float64 tensRes, const gpPoint2d& tensResLoc)
{
   m_CompRes    = compRes;
   m_CompResLoc = compResLoc;
