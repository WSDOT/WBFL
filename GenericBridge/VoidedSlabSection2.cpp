...
void CVoidedSlabSection2::GetWebs(Float64* pIntWeb,Float64* pExtWeb)
{
   ...
   m_Beam->get_InteriorVoidSpacing(&S);
   m_Beam->get_InteriorVoidDiameter(&D);
   m_Beam->get_Width(&W);
...
STDMETHODIMP CVoidedSlabSection2::get_GirderHeight(Float64* height)
{
...
STDMETHODIMP CVoidedSlabSection2::Clone(IShape** pClone)
{
   ...
   CComPtr<IVoidedSlabSection2> flanged_beam = clone;
