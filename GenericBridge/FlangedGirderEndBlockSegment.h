...
//   public CComRefCountTracer<CSegment,CComObjectRootEx<CComSingleThreadModel> >,
   ...
   public CProxyDSegmentEvents< CFlangedGirderEndBlockSegment >,
   public IConnectionPointContainerImpl<CFlangedGirderEndBlockSegment>,
...
BEGIN_CONNECTION_POINT_MAP(CFlangedGirderEndBlockSegment)
	CONNECTION_POINT_ENTRY(IID_ISegmentEvents)
END_CONNECTION_POINT_MAP()

private:
   Float64 m_Length;
   CComPtr<IFlangedGirderSection> m_Beam;
...
public:
	STDMETHOD(putref_FlangedGirderSection)(/*[in]*/ IFlangedGirderSection* pPrecastBeam);
