...
HRESULT CFlangedSplicedGirderSegment::GetSection(StageIndexType stageIdx,Float64 distAlongSegment,ISection** ppSection)
{
   ...
   else
   {
      ...
      m_ClosurePourMaterial[endType]->get_E(stageIdx,&Efg);
   }
   ...
   {
      EndType endType(isClosurePour < 0 ? etStart : etEnd);
      m_ClosurePourMaterial[endType]->get_Density(stageIdx,&Dfg);
   }
