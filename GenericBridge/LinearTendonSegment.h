...
public:
   STDMETHOD(putref_Start)(/*[in]*/ IPoint3d* start);
	STDMETHOD(get_Start)(/*[out,retval]*/ IPoint3d** start);
	STDMETHOD(putref_End)(/*[in]*/ IPoint3d* end);
   STDMETHOD(get_End)(/*[out,retval]*/ IPoint3d** end);

// ITendonSegment
public:
   STDMETHOD(get_Position)(/*[in]*/ Float64 x,/*[out,retval]*/ IPoint3d** cg);
	STDMETHOD(get_Slope)(/*[in]*/ Float64 x,/*[out,retval]*/ IVector3d** slope);
