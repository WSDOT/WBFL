...
STDMETHODIMP CUGirderSection::get_MatingSurfaceLocation(MatingSurfaceIndexType idx,Float64* location)
{
   return get_TopFlangeLocation(idx,location);
}

STDMETHODIMP CUGirderSection::get_MatingSurfaceWidth(MatingSurfaceIndexType idx,Float64* wMatingSurface)
{
...
STDMETHODIMP CUGirderSection::get_TopWidth(Float64* width)
{
   return m_Beam->get_TopWidth(width);
}

STDMETHODIMP CUGirderSection::get_BottomWidth(Float64* width)
{
...
STDMETHODIMP CUGirderSection::Clone(IShape** pClone)
{
   ...
   CComPtr<IUGirderSection> flanged_beam = clone;
