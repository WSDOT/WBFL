...
STDMETHODIMP CRebarFactory::CreateRebar(MaterialSpec spec,RebarGrade grade,BarSize size,IUnitConvert* pConvert,StageIndexType stageIdx,IRebar** rebar)
{
   CHECK_RETOBJ(rebar);
   ...
   (*rebar)->Init(bstrName,E,weight,fu,fy,db,as,stageIdx);
